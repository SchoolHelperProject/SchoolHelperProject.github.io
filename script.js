...
function classesMainSearch(searchFilter) {
    ...
    sortArr.forEach((item) => {
        ...
        if(regexpSearch.test(updateText) && statusSearch === true) {
...
function TeachMainSearch(searchFilter) {
    ...
    sortTeachArr.forEach((item, index) => {
        let text = item.name.toLowerCase() + ' ' + item.surname.toLowerCase() + ' ' + item.thirdname.toLowerCase();
        //console.log(text);
        let statusSearch = true;
        let updateText  = text.replace(regSpace,'');
...
function searchList(usersArray,selector,userSearchValue) {
    ...
    usersArray.forEach((item) => {
        ...
        let updateText  = text.replace(regSpace,'');
        if(((updateText + '' ) != updateUserText) && statusSearch === true) {
